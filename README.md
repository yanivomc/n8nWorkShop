...
| S3 | Reacting to Kubernetes Events | 60 min | ⛔ DEACTIVATED (replaced by S5) |
| S4 | The Telegram Human Loop | 60 min | ✅ READY (always active) |
| S5 | Alert Intelligence (production S3) | 60 min | ✅ READY |
